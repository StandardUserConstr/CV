...
;gcc -m32 -c kernel_main.c -o kernel_main.o -ffreestanding -nostdlib -nostdinc -Wall -Wextra -Werror -lgcc -O2 -s
;ld -m i386pe -o kernel.o -Ttext 0x1000 kernel_entry.o kernel_main.o
;objcopy -O binary -j .text kernel.o kernel.bin
;type boot.o kernel.bin > drive.bin

;C:\MainDirect\qemu\qemu-system-x86_64 C:\nasm-2.15.05\test_projects\002\drive.bin -monitor stdio
